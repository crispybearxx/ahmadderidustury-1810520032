...
if (isset($_POST["bsimpan"])) {
	...
	if (tambahvaksin($_POST)>0) {
		...
		document.location.href='vaksin.php';
		</script>
		";
	}else{
		echo "
	...
	<div class="container">
		...
		<div class="card mt-3">
			<div class="card-header bg-danger text-white">
				Input Jenis Vaksin COVID-19
			</div>
			<div class="card-body">
				<form method="post" action="">
					<div class="form-group">
						<label>Kode</label>
						<input type="text" name="kode" class="form-control" placeholder="Masukkan Kode Vaksin!" required>
					</div>
					<div class="form-group">
						<label>Jenis Vaksin</label>
						<input type="text" name="Jenis_Vaksin" class="form-control" placeholder="Masukkan Jenis Vaksin!" required>
					</div>
					<div class="form-group">
						<label>Nama</label>
						<input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Vaksin!" required>
					</div>
