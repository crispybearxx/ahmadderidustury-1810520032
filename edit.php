...
$id = $_GET["id"];
$tampil = query("SELECT * FROM pendaftaran WHERE id = $id")[0];
	...
	<div class="container">
		...
		<div class="card mt-3">
			<div class="card-header bg-dark text-white">
				Form Edit Data Penerima Vaksin COVID-19
			</div>
			<div class="card-body">
				<form method="post" action="">
					<input type="hidden" name="id" class="form-control" value=" <?php echo $tampil["id"]; ?> " required>
					<div class="form-group">
						<label>NIK</label>
						<input type="text" name="NIK" class="form-control" value=" <?php echo $tampil["NIK"]; ?> " required>
					</div>
					<div class="form-group">
						<label>Nama</label>
					...
					<div class="form-group">
						...
						<input type="text" name="tgl_lahir" class="form-control" value=" <?php echo $tampil["tgl_lahir"]; ?> " required>
					</div>
					<div class="form-group">
						<label>Alamat</label>
						<input class="form-control" name="alamat" value=" <?php echo $tampil["alamat"] ;?> "></input>
					</div>
					<div class="form-group">
